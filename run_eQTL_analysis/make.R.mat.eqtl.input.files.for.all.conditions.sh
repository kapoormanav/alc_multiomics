...
cat <<EOF > run.matrix.eqtl.chr$file.$out.R
...
# Genotype file name
SNP_file_name = paste(base.dir, "/hpc/users/kapoom02/6/from_scratch_SMR/Fairfax_hrc/EQTL_analysis/fairfax.chr$file.$out.qced.txt", sep="");
snps_location_file_name = paste(base.dir, "/hpc/users/kapoom02/6/from_scratch_SMR/Fairfax_hrc/EQTL_analysis/peer_expression/fairfax.chr$file.$out.qced.location.txt", sep="");

# Gene expression file name
expression_file_name = paste(base.dir, "/hpc/users/kapoom02/6/from_scratch_SMR/Fairfax_hrc/EQTL_analysis/$out.PEER_20.expression.txt", sep="");
...
snps\$LoadFile("/hpc/users/kapoom02/6/from_scratch_SMR/Fairfax_hrc/EQTL_analysis/fairfax.chr$file.$out.qced.txt");
...
gene\$LoadFile("/hpc/users/kapoom02/6/from_scratch_SMR/Fairfax_hrc/EQTL_analysis/peer_expression/$out.PEER_20.expression.txt");
...
snpspos = read.table("/hpc/users/kapoom02/6/from_scratch_SMR/Fairfax_hrc/EQTL_analysis/fairfax.chr$file.$out.qced.location.txt", header = TRUE, stringsAsFactors = FALSE);
...
write.table(cis_out, "cis.eqtls.fairfax.chr$file.$out.qced.07.01.19.txt", row.names=FALSE, quote=FALSE)
#cat('Detected distant eQTLs:', '\n');
#trans_out <- me\$trans\$eqtls
#write.table(trans_out, "trasn.eqtl.fairfax.$file.$out.qced.txt")
#show(me$trans$eqtls)
